...
export const metadata: Metadata = {
  title: "Core 2 (220-1102) Practice Tests - A+ Prep",
  description: "Master the CompTIA A+ 220-1102 Core 2 exam with our 15 practice tests covering all exam objectives.",
};
