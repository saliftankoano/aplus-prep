        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link
                href="/tests"
                className="bg-blue-600 text-white px-5 py-2 rounded-full hover:bg-blue-700 transition-all shadow-md hover:shadow-lg text-sm font-medium"
              >
                Start Practicing
              </Link>
            </div>
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <motion.div
              variants={fadeIn}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 text-blue-700 font-medium text-sm mb-8 border border-blue-100"
            >
            ...
            <motion.h1
              variants={fadeIn}
              className="text-5xl md:text-7xl font-bold text-gray-900 tracking-tight mb-8 leading-tight"
            >
              Master the <span className="text-blue-600">CompTIA A+</span>
              <br />
            ...
            >
              Comprehensive practice tests for Core 1 (220-1101) & Core 2
              (220-1102). Simulation-based learning designed to help you pass on
              your first try.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              { label: "Pass Rate", value: "94%", icon: TrendUpIcon },
              { label: "Uptime", value: "99.9%", icon: LightningIcon },
            ].map((stat, i) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Select the exam you&apos;re preparing for. We provide
              comprehensive coverage for both Core 1 and Core 2 exams.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Core 1 Card */}
            <div className="group relative bg-white rounded-3xl border border-gray-200 p-8 hover:border-blue-200 hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-300 overflow-hidden">
              ...
              <div className="mb-6 inline-block p-4 bg-blue-50 rounded-2xl text-blue-600">
                <MonitorIcon size={32} weight="duotone" />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-2">
                Core 1 (220-1101)
              </h3>
              <p className="text-gray-600 mb-8">
                Focuses on mobile devices, networking technology, hardware,
            ...
            {/* Core 2 Card */}
            <div className="group relative bg-white rounded-3xl border border-gray-200 p-8 hover:border-indigo-200 hover:shadow-2xl hover:shadow-indigo-500/10 transition-all duration-300 overflow-hidden">
              ...
              <div className="mb-6 inline-block p-4 bg-indigo-50 rounded-2xl text-indigo-600">
                <CpuIcon size={32} weight="duotone" />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-2">
                Core 2 (220-1102)
              </h3>
              <p className="text-gray-600 mb-8">
                Covers installing and configuring operating systems, expanded
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-gray-200 rounded-lg flex items-center justify-center">
                <ShieldIcon size={20} weight="fill" className="text-gray-600" />
              </div>
            ...
            <div className="text-sm text-gray-500">
              ...
              for Professor Michael Williams
            </div>
          </div>
        </div>
      </footer>
